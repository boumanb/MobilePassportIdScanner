...
public class MyScanActivity extends Activity implements ScanResultListener, CameraEventsListener, OnSizeChangedListener, MetadataListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_myscanactivity);
        ...
        try {
            mRecognizerView.setLicenseKey("YOURLICENSEKEYHERE");
        ...
        mBackButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(getApplicationContext(), ScannedListActivity.class);
                startActivity(i);
            }
        });
    ...
    public void onScanningDone(RecognitionResults results) {
            ...
            i.putExtra(ScanActivity.EXTRAS_RECOGNITION_RESULTS, results);
            setResult(RESULT_OK, i);
            i.putExtra("INTENTFROM", "ScanActivity");
            startActivity(i);
        }
